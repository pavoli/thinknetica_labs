...
class VacancyLargeResultsSetPagination(PageNumberPagination):
    page_size = 10
...
class VacancyViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = Vacancy.objects.all().order_by('-publish_date')
    serializer_class = VacancySerializer
    pagination_class = VacancyLargeResultsSetPagination
    filter_backends = [filters.SearchFilter]
    search_fields = ['vacancy_name', 'vacancy_description', 'salary_min', 'key_skill__name']
